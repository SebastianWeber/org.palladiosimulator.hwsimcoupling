...
/**
 * @author Sebastian Executes {@link org.palladiosimulator.hwsimcoupling.commands.Command}
 */
public class CommandExecutor {
    ...
    /**
     * Executes the given {@link org.palladiosimulator.hwsimcoupling.commands.Command} and connects
     * the output and error streams to the given consumers
     * 
     * @param command
     ...
     */
    public static void executeCommand(Command command, Consumer<String> outputConsumer, Consumer<String> errorConsumer)
            throws IOException, InterruptedException {
        String commandLogging = "Executing command: ";
        for (String commandPart : command.getCommand()) {
        ...
        try {
            CompletableFuture.runAsync(new StreamRedirector(process.getInputStream(), outputConsumer))
                .get();
            CompletableFuture.runAsync(new StreamRedirector(process.getErrorStream(), errorConsumer))
                .get();
