...
public interface ResourceModelHelper {
	...
	public default String getCurrentContainerID(SimuComModel simuComModel) {
        Optional<SimulatedResourceContainer> simContainer = simuComModel.getResourceRegistry().getSimulatedResourceContainers().stream()
        ...
        return simContainer.get().getResourceContainerID();
	}
	
	public default Map<String, Serializable> addCurrentContainerID(SimuComModel simuComModel, Map<String, Serializable> map) {       
