...
/**
 * @author Sebastian
 * A command that can be executed with the 
...
public interface Command {
	 ...
	 * {@link org.palladiosimulator.hwsimcoupling.util.impl.CommandExecutor#execute_command(List, java.util.function.Consumer, java.util.function.Consumer)}
	 */
	 ...
	 */
	public default List<String> get_shell() {
